...
result4_7.defaultProps = {
    subject_name: "직장 mbti 테스트",
    sub_context:
        "당신은 <span>swgu 유형</span> 입니다! <br/> 이 타입은 중소기업 보단 <span>스타트업</span>을 선호하고, 연봉보다 <span>워라밸을 중시</span>하는 편입니다. 또, 다른 직무보다 <span>개발</span>을 좋아해 개발 직무를 선호하시네요. 그리고, 동기보다 선임 둘 중에 고르자면 <span>선임</span>이 좋은 회사를 선호하는 특징이 있습니다. :-)"
};
