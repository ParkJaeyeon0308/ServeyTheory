            ...
            <div className="Question">
                <div className="container">
                    ...
                    <div className="buttons">
                        <Button onClick={() => 
                            this.props.history.push("/question7_4")
                        }
                        >
                            <div
                                className="btn1"
...
question.defaultProps = {
    question_title:
        "Q3. 다른 사람이 만들어 높은 서비스를 사용하면서 어떤 부분을 생각하나요?",
    btn1: "프로그램을 볼 때 기능을 보려다가 <br>메뉴의 색깔이 신경쓰인다",
    btn2: "버튼 크기가 뭐가 이상하다는건지 잘 모르겠다",
    btn3: "필요한 사이트의 회원가입을 하다가 오류가 났다. <br> 내가 해버리고 싶다",
    btn4: "친구에게 웃긴 썰을 보내려 url을 복사했는데 <br> 너무 긴 url이 신경쓰여서 단축해서 보내버렸다."
};
