...
function Question7_2() {
    ...
    const btn1 = (
        <>
            여러 분야의 기획자들과 <br /> 전체적인 커뮤니케이션을 활발히 하는
            스타일
        </>
    ); //F
    const btn2 = (
        <>
            적당히 회의를 했으면 정해진 기능을 <br />
            정확하게 파악하고 바로 개발 할 준비를 한다
        </>
    ); //B
    const btn3 = (
        <>
    ...
    const btn4 = (
        <>
            기획을 할때 개발하면서 기타 옵션으로 <br />
            다른 프로그램을 사용해 이것 저것 추가하도록 한다
        </>
    ); //BF
    return (
        <div className="Question">
            <div className="container">
                ...
                <div className="buttons">
                    <Link to="./Question7_3" style={{ textDecoration: "none" }}>
