...
class result4_10 extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        const imgUrl = "/images/result/type4/jyau.png";
...
// 기본 props 값
result4_10.defaultProps = {
    subject_name: "직장 mbti 테스트",
    sub_context:
        "당신은 <span>jyau 유형</span> 입니다! <br/> 이 타입은 스타트업보다 <span>중소기업</span>을 선호하고, 워라밸보다는 <span>연봉을 중시</span>하는 편입니다. 또, 개발을 제외한 운영, 사무 등 다른 직무와도 잘 어울리시네요. 동기보다 선임 둘 중에 고르자면 <span>선임</span>이 좋은 회사를 선호하는 특징이 있습니다. :-)"
};

export default result4_10;
